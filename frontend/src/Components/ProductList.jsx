...
const ProductList = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h2 className="text-3xl font-bold text-center text-gray-700 mb-8">Shop Our Best Picks! 💖</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {products.map((product) => (
          ...
          >
            <img src={product.image} alt={product.name} className="w-44 h-44 object-cover mb-4 rounded-lg" />
            ...
            <button className="bg-gradient-to-r from-pink-500 to-red-500 text-white px-5 py-2 rounded-full mt-4 flex 
